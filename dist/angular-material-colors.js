(function () {
    ...
    angular
        .module('angularMaterialColors',['ngMaterial'])
        .service("angularMaterialColors", angularMaterialColors)
        .config(configColors)
        .run(loadDefaults);
    ...
    loadDefaults.$inject=['angularMaterialColors'];
    function loadDefaults(angularMaterialColors) {
        // this sets the default that is stored in the config-fase into the service!
        angularMaterialColors.themes=Object.keys(colorStore);
        angularMaterialColors.loadColors('amber');
    }
    
    angularMaterialColors.$inject = ['$interpolate'];
    function angularMaterialColors ($interpolate) {
